...
[https://github.com/user-attachments/assets/a0b2ae2e-23be-49a4-b301-3fa27a03f3c5](https://github.com/LuccaBertani/TP-SO/blob/main/FIBO_47.mp4)

* En el ejemplo, se puede observar que tras la ejecución de los hilos planificados por Kernel, en AX quedó almacenado el número 46 de la sucesión de Fibonacci (1836311903), y en BX el número 47 de la misma (2971215073), por lo cual se llegó al objetivo que tenía el pseudocódigo ingresado en Kernel.
